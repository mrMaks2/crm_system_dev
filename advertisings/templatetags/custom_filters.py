...
def get_cluster_color(cluster_name):
    ...
    colors = {
        ...
        'Кыргызстан': '#A569BD',            # Фиолетовый средний - добавлен для Кыргызстана

        # Новые цвета для объединенных регионов
        'Центральный + Беларусь': '#FF6B6B',           # Яркий красный
        'Южный + Северо-Кавказский + Армения + Азербайджан': '#45B7D1', # Яркий голубой
        'Уральский + Казахстан + Узбекистан + Кыргызстан': '#96CEB4',    # Мятный зеленый
        'Дальневосточный + Сибирский': '#98D8C8'       # Зеленый океан
    }
...
def get_cluster_color_light(cluster_name):
    ...
    colors = {
        ...
        'Кыргызстан': '#EBDEF0',            # Светло-лавандовый - добавлен для Кыргызстана

        'Центральный + Беларусь': '#FFE5E5',           # Светло-красный
        'Южный + Северо-Кавказский + Армения + Азербайджан': '#E3F2FD', # Светло-голубой
        'Уральский + Казахстан + Узбекистан + Кыргызстан': '#E8F5E8',    # Светло-зеленый
        'Дальневосточный + Сибирский': '#E0F2F1'       # Светло-морской
    }
