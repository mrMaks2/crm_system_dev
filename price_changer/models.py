...
class Product_from_wb(models.Model):
    ...
    price_without_discount_wb = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='Цена бес учета скидки от кошелька')
    ...
    discount_wb = models.DecimalField(max_digits=10, decimal_places=0, null=True, blank=True, verbose_name='Скидка от WB от кошелька')
...
class Product_from_ozon(models.Model):
    ...
    price_without_discount_ozon = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='Цена бес учета скидки от кошелька')
    ...
    discount_ozon = models.DecimalField(max_digits=10, decimal_places=0, null=True, blank=True, verbose_name='Скидка от WB от кошелька')
