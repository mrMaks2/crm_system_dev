...
class Product_from_ozon(models.Model):
    ...
    discount_co_invest = models.IntegerField(null=True, blank=True, verbose_name='Скидка соинвеста')
    discount_ozon_with_wallet = models.IntegerField(null=True, blank=True, verbose_name='Скидка кошелька Ozon')
